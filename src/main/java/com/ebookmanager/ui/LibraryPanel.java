...
public class LibraryPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        btnCollection.setBackground(new java.awt.Color(204, 204, 204));
        btnCollection.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        btnCollection.setText("Collection");
        btnCollection.setPreferredSize(new java.awt.Dimension(100, 40));
        ...
        pnlTopLayout.setHorizontalGroup(
            ...
            .addGroup(pnlTopLayout.createSequentialGroup()
                ...
                .addComponent(btnCollection, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(22, 22, 22))
        );
        pnlTopLayout.setVerticalGroup(
            ...
            .addGroup(pnlTopLayout.createSequentialGroup()
                .addGap(18, 18, 18)
                .addComponent(btnCollection, javax.swing.GroupLayout.PREFERRED_SIZE, 31, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
    ...
    private void loadLibrary(String keyword) {
        ...
        if (progresses == null || progresses.isEmpty()) {
            ...
            for (BookProgress bp : progresses) {
                ...
                bookCard.setBackground(new Color(245, 245, 245)); 
                ...
                lblTitle.addMouseListener(new MouseAdapter() {
                    public void mouseClicked(MouseEvent e) {
                        if(mainView != null) {
                            mainView.openReadingView(book, false); // Mở sách để đọc
                        }
                    }
                });
    ...
    private void showViewCollectionsDialog() {
        ...
        btnRen.addActionListener(e -> {
            ...
            } else { JOptionPane.showMessageDialog(dialog, "Please select a collection."); }
        });
    ...
    private void showCollectionDetailDialog(Collection col) {
        ...
        styleFlowButton(btnAdd); btnAdd.setPreferredSize(new Dimension(100, 40));
        
        JButton btnRem = new JButton("Remove Book");
        styleFlowButton(btnRem); btnRem.setPreferredSize(new Dimension(120, 40));
        ...
        btnRem.addActionListener(e -> {
            ...
            } else { JOptionPane.showMessageDialog(dialog, "Select a book to remove."); }
        });
    ...
    private void showAddBookDialog(JDialog parent, Collection col, Runnable onDone) {
        ...
        searchP.add(txtS); searchP.add(btnS);
        ...
        Runnable load = () -> {
            ...
            if (filteredBooks.isEmpty()) listP.add(new JLabel("No matching books in your Library."));
            ...
            for (Book b : filteredBooks) {
                ...
                p.addMouseListener(new MouseAdapter() {
                    public void mouseClicked(MouseEvent e) {
                        ...
                        selP[0] = p; selBook[0] = b;
                        p.setBackground(new Color(52, 152, 219));
                    }
                });
                listP.add(p); listP.add(Box.createVerticalStrut(5));
            }
            listP.revalidate(); listP.repaint();
        };
        ...
        btnAdd.addActionListener(e -> {
            ...
            } else { JOptionPane.showMessageDialog(dialog, "Select a book first."); }
        });
        ...
        dialog.addWindowListener(new java.awt.event.WindowAdapter() {
            @Override
            public void windowClosed(java.awt.event.WindowEvent e) { onDone.run(); }
        });
        dialog.setVisible(true);
    }
